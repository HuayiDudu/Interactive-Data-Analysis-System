...
| 负责人 | 文件 |
|--------|------|
| 项目负责人 | `config.py`, `value_objects.py`, `repositories/*`, `app.py`, `requirements.txt`, `.gitignore`, `githooks/*` |
| 数据管理模块 | `services/data_service.py`, `routes/upload.py`, `routes/export.py`, `static/js/upload.js` |
...
| 进度跟踪 | `docs/进度跟踪.md` |
| 原始架构说明 | `docs/交互式数据分析系统 - 开发说明文档.md` |
